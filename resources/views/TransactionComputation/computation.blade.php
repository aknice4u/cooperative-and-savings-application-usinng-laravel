@extends('Layouts.adminLayoutTest')
@section('pageTitle')
           ...
           <div class="col-md-12 col-xs-12 col-ms-12 grid-margin grid-margin-md-0 stretch-card">
			...
			<thead>
				<tr bgcolor="">
						...
						<tr bgcolor="#ff4933" style="color:#fff !important;"> @else <tr> @endif
							...
							<td><button type= "button" class="btn btn-success btn-sm" onclick="Modify('{{$b->regno}}')" style="padding:2px !important">Edit</button></td>
						</tr>

           ...
           <div class="col-md-12 col-xs-12 col-ms-12 grid-margin grid-margin-md-0 stretch-card">
            ...
            <div class="container">
                ...
                <div class="row">
				    ...
				    <div class="col-sm-3">
				    	<label >Year:</label>
				      	<select type="text" id="year" name="year" class="formex form-control" onchange="ReloadForm()">
				    ...
				    <div class="col-sm-3">
				    	<label>Month:</label>
				      	<select type="text" id="month" name="month" class="formex form-control"  onchange="ReloadForm()">
			...
			<thead>
				<tr bgcolor="#c7c7c7">
						...
						@foreach ($TransactionReport  as $b) 
						@php $summonthly_contribution += $b->monthcontribution; @endphp
						@php $sumloan_repay += $b->loanrepay; @endphp
						@php $suminterest_repay += $b->interestrepay; @endphp
						...
						<tr>
							...
							<td><button type= "button" class="btn btn-success btn-sm" onclick="Modify('{{$b->ID}}')">Edit</button></td>
							
						</tr>
						
						<input id ="{{$b->ID}}contribution" type="hidden"  value="{{$b->monthcontribution}}">
						<input id ="{{$b->ID}}loan" type="hidden"   value="{{$b->loanrepay}}">
						<input id ="{{$b->ID}}interest" type="hidden"   value="{{$b->interestrepay}}">
						<input id ="{{$b->ID}}names" type="hidden"   value="{{$b->Names}}">
						@endforeach	
						<tr>

    ...
    <nav class="navbar horizontal-layout col-lg-12 col-12 p-0">
        ...
        <div class="container d-flex flex-row h-100">
          ...
          <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
            ...
            <ul class="navbar-nav navbar-nav-right mr-0">
              ...
              <li> <b>Welcome To Member Portal</b> &nbsp;&nbsp;  | </li>
              <li class="nav-item nav-profile dropdown">
                <a class="nav-link" href="#" dropdown-toggle" id="accountDropdown" href="#" data-toggle="dropdown">
      ...
      <div class="nav-bottom">
        <div class="container">
          <ul class="nav page-navigation">
             ...
             <li class="nav-item">
              ...
              <div class="submenu">
                <ul class="submenu-item">
                  <li class="nav-item"><a class="nav-link" href="{{url('/self-transaction/history')}}">Transaction History</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{url('/loan-request/create')}}">Loan request form</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{url('/my-request/list')}}">My Loan Requests</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{url('/self-archive/report')}}">Transaction Archive History</a></li>
                  <li class="nav-item"><a class="nav-link" href="/edit-contribution">Change monthly contributions</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="submenu">
                <ul class="submenu-item">
                  <li class="nav-item"><a class="nav-link" href="{{ route('committee') }}">Board of Committee</a></li>
        ...
        <footer class="footer hidden-print">
          <div class="w-100 clearfix hidden-print">

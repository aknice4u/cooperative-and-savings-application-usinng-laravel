              ...
              <div class="card bg-success text-white border-0">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ml-4">
                      <h4 class="font-weight-light">Total Saving</h4>
                      <h3 class="font-weight-light mb-3">&#8358; {{ number_format($totalLoanSaving, 2, '.', ',') }}</h3>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card bg-danger text-white border-0">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ml-4">
                      <h4 class="font-weight-light">Total Unpaid Loan</h4>
                      <h3 class="font-weight-light mb-3">&#8358; {{ number_format($totalUnpaidLoanInterest->unpaidloan, 2, '.', ',') }}</h3>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card bg-danger text-white border-0">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <i class="icon-screen-desktop icon-lg"></i>
                    <div class="ml-4">
                      <h4 class="font-weight-light">Total Unpaid Interest</h4>
                      <h3 class="font-weight-light mb-3">&#8358; {{ number_format($totalUnpaidLoanInterest->unpaidinterest, 2, '.', ',') }}</h3>
                    </div>
                  </div>
                </div>
              </div>

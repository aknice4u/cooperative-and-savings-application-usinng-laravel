...
<body style="background: #E3E5E7;">
  <div style="background-color:#E3E5E7;"><!--[if mso | IE]>
      ...
      <![endif]-->
      <div style="margin:0 auto;max-width:600px;background:#277DF4;"><table cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#277DF4;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;font-size:0px;padding:20px 0px;"><!--[if mso | IE]>
      ...
      <!--image logo-->
      </td></tr></tbody></table></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:0px 20px 0px 20px;" align="center"><div style="cursor:auto;color:white;font-family:'Avenir Next', Avenir, sans-serif;font-size:32px;line-height:60ps;">
            Click Below Button To Verify Your Email
      ...
      <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table cellpadding="0" cellspacing="0" align="center" border="0"><tbody><tr><td style="border-radius:3px;color:white;cursor:auto;" align="center" valign="middle" bgcolor="#EB5424">
        
        <a href="{{url('http://virads.com.ng/verify/email/'.$emailCode)}}" style="display:inline-block;text-decoration:none;   background:#277DF4;border-radius:3px;color:white;font-family:'Avenir Next', Avenir, sans-serif;
              font-size:14px;font-weight:500;line-height:35px;padding:10px 25px;margin:0px;" target="_blank">
            VERIFY YOUR EMAIL
        </a>

        <br /> or copy below link and paste to your URL

        <a href="{{url('http://virads.com.ng/verify/email/'.$emailCode)}}" target="_blank" style="color:#277DF4">
          http://virads.com.ng/verify/email/{{$emailCode}}
        </a>
      ...
      <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0px 20px;" align="center"><div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:13px;line-height:20px;">
           “You received this email because you are interested in one of Virads Media Services.” <br />
